...
export default {
  ...
  mounted() {
    this.$nextTick(() => {
      // this.getFishingWaterQualityStation()
    })
  },
  methods: {
    getFishingWaterQualityStation() {
      getWaterQualityStations({
        ...
        icons.forEach(item => {
          ...
          const data = {
            ...
            layer: 'fishingWaterQualityStation',
            icon: 'icon_fishing_water_quality_station.png',
            tooltip: item.province + item.city + '渔业水质监测点位'
          }
          if (item.level) {
