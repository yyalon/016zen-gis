...
import ChartPollutantCityPie from '../chart/PollutantCityPie.vue'
import ChartPollutantSeaFlux from '../chart/PollutantSeaFlux.vue'
...
<template>
  <div>
    ...
    <RightDrawer :drawer-visible="visible">
      <ChartPollutantSeaFlux />
      <ChartPollutantEstuaryBay />
    </RightDrawer>
  </div>
</template>
